...
//    Kafka template that takes in a string
...
//    Changes in me Template wired with Changes producer factory

    @Bean
    public KafkaTemplate<String, ChangesInMe> changesInMeTemplate() {
        return new KafkaTemplate<>(changesInMeFactory());
    }
}
